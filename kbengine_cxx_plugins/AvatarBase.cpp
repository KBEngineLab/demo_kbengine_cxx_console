...
void AvatarBase::onRemoteMethodCall(MemoryStream& stream)
{
	...
	switch(pMethod->methodUtype)
	{
		case 10101:
		{
			...
			KBString dialog_addOption_arg3 = stream.readUnicode();
		...
		case 10102:
		{
			KBString dialog_setText_arg1 = stream.readUnicode();
			uint8 dialog_setText_arg2 = stream.readUint8();
			uint32 dialog_setText_arg3 = stream.readUint32();
			KBString dialog_setText_arg4 = stream.readUnicode();
...
void AvatarBase::onUpdatePropertys(MemoryStream& stream)
{
	...
	while(stream.length() > 0)
	{
		...
		switch(pProp->properUtype)
		{
			...
			case 40001:
			{
				KBVector3f oldval_direction = direction;
			...
			case 40000:
			{
				KBVector3f oldval_position = position;
...
void AvatarBase::callPropertysSetMethods()
{
	...
	KBMap<uint16, Property*>& pdatas = sm->idpropertys;
...
AvatarBase::AvatarBase():
	...
	pCellEntityCall(NULL),
	HP((int32)safe_atoi64(KBTEXT("0"))),
	HP_Max((int32)safe_atoi64(KBTEXT("0"))),
	MP((int32)safe_atoi64(KBTEXT("0"))),
	MP_Max((int32)safe_atoi64(KBTEXT("0"))),
	component1(static_cast<TestBase*>(EntityComponentFactory::instance().create("Test").release())),
	component2(static_cast<TestBase*>(EntityComponentFactory::instance().create("Test").release())),
	component3(static_cast<TestNoBaseBase*>(EntityComponentFactory::instance().create("TestNoBase").release())),
	forbids((int32)safe_atoi64(KBTEXT("0"))),
	level((uint16)safe_atoi64(KBTEXT("0"))),
	modelID((uint32)safe_atoi64(KBTEXT("0"))),
	modelScale((uint8)safe_atoi64(KBTEXT("30"))),
	moveSpeed((uint8)safe_atoi64(KBTEXT("50"))),
	name(KBTEXT("")),
	own_val((uint16)safe_atoi64(KBTEXT("0"))),
	spaceUType((uint32)safe_atoi64(KBTEXT("0"))),
	state((int8)safe_atoi64(KBTEXT("0"))),
	subState((uint8)safe_atoi64(KBTEXT("0"))),
	uid((uint32)safe_atoi64(KBTEXT("0"))),
	utype((uint32)safe_atoi64(KBTEXT("0")))
{
...
KBArray<EntityComponent*> AvatarBase::getComponents(KBString componentName, bool all)
{
